...
class Imagemoo_lib
{
	...
	//----------------------------------------------------------------------------------------------------------
	{
		...
		imagecolortransparent( $this->temp_image, imagecolorallocatealpha( $this->temp_image, 255, 255, 255, 127 ) );
    	...
    	*/
		...
		if (!$pad)
		{
			...
			*/
			...
			imagealphablending($this->temp_image, false);
			imagesavealpha($this->temp_image, true);
			$color = imagecolorallocatealpha($this->temp_image, 255, 255, 255, 127);
