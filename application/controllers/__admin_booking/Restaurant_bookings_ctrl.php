...
class Restaurant_bookings_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        if (isset($sort_start_date)) {
            $search_conditions['sort_start_date'] = trim($sort_start_date);
            if($sort_start_date=='ASC'){
                $this->_pdata['sort_start_date'] = 'entypo-up-open';
            }
            else{
                $this->_pdata['sort_start_date'] = 'entypo-down-open';
            }
            
        } else {
            $search_conditions['sort_start_date'] = null;
            $this->_pdata['sort_start_date'] = null;
        }
        ...
        $this->load->model('__admin_booking/Restaurant_bookings_mdl');
        ...
        $this->template_lib->load_view($this, '__admin_booking/Restaurant_booking_list_view', $this->_pdata);
    }
	...
	public function get() {
        ...
        $this->template_lib->load_view($this, '__admin_booking/Restaurant_booking_view', $this->_pdata);
    }
	
	public function confirm_bookings(){
        $this->load->model('__admin_booking/Restaurant_bookings_mdl');
        $this->Restaurant_bookings_mdl->confirm_bookings($this->input->get('data'));
    ...
    public function cancel_bookings(){
        $this->load->model('__admin_booking/Restaurant_bookings_mdl');
        $this->Restaurant_bookings_mdl->cancel_bookings($this->input->get('data'));
