...
class Golf_bookings_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->model('__vendor_booking/Golf_bookings_mdl');
        ...
        foreach ($golf_bookings as $golf_booking) {
            ...
            $booking_ids_array[] = $golf_booking['booking_id'];  
            $this->_pdata['golf_bookings'][] = $golf_booking;
        }
        
        if(isset($booking_ids_array) && !empty($booking_ids_array)) {
            $invoice_paths = $this->Golf_bookings_mdl->get_invoice_paths($booking_ids_array);
        } else {
            $invoice_paths = array();
        }
        ...
        $this->_pdata['pagination'] = generate_pagination($this, 'vendor/booking/Golf-bookings', $this->_pdata['total_golf_bookings'], $limit);
        ...
        $this->template_lib->load_view($this, '__vendor_booking/Golf_bookings_list_view', $this->_pdata);
    }
    ...
    public function get() {
        ...
        $this->template_lib->load_view($this, '__vendor_booking/Golf_bookings_view', $this->_pdata);
    }
    ...
    public function invoice() {
        ...
        $this->load->model('__vendor_booking/Golf_bookings_mdl');
        $invoice = $this->Golf_bookings_mdl->get_invoice_path($golf_booking_id);
    ...
    public function raise_invoice() {
	    if ($this->input->is_ajax_request()) {
	        ...
	        if ($this->form_validation->run() == FALSE) {
	            ...
	            $this->Golf_bookings_mdl->add_invoice_no_with_date($data);
	            /* 
	             * END OF FIXED
	             * 
	             *  */
