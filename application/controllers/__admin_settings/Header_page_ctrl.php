...
/*
 * APPLICATION 		: Header Page Controller
...
class Header_page_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        $this->template_lib->load_view($this, '__admin_settings/Header_page_view', $this->_pdata);
    }
}