...
/*
 * APPLICATION 		: Footer Page Controller
...
class Footer_page_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        $this->template_lib->load_view($this, '__admin_settings/Footer_page_view', $this->_pdata);
    }
}