...
/*
 * APPLICATION 		: Club And Bar Page Controller
...
class Club_and_bar_page_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        if($this->input->post()) {
            $this->form_validation->set_rules('config[club_and_bar][details_en][main_title]', 'Main Title', 'trim|required|min_length[3]|max_length[255]',
                array(
        ...
        $this->template_lib->load_view($this, '__admin_settings/Club_and_bar_page_view', $this->_pdata);
    }
}