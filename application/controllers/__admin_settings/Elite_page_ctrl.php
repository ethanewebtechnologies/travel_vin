...
/*
 * APPLICATION 		: Elite Page Controller
...
class Elite_page_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        if($this->input->post()) {
            $this->form_validation->set_rules('config[elite][details_en][main_title]', 'Main Title', 'trim|required|min_length[3]|max_length[255]',
                array(
        ...
        $this->template_lib->load_view($this, '__admin_settings/Elite_page_view', $this->_pdata);
    }
}