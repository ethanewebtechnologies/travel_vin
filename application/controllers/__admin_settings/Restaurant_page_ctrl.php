...
/*
 * APPLICATION 		: Restaurant Page Controller
...
class Restaurant_page_ctrl extends CI_Controller {
    ...
    public function index() {
        ...
        if($this->input->post()) {
            $this->form_validation->set_rules('config[restaurant][details_en][main_title]', 'Main Title', 'trim|required|min_length[3]|max_length[255]',
                array(
        ...
        $this->template_lib->load_view($this, '__admin_settings/Restaurant_page_view', $this->_pdata);
    }
}