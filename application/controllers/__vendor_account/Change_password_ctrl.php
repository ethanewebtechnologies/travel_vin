...
class Change_password_ctrl extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->lang->load('__vendor_account/Change_password', $siteLang);
    ...
    public function index() {
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->Manage_mdl->change_password($this->input->post(), $this->input->post('vendor_id'));
               redirect('vendor/account/change-password/change_password_success', 'referesh');
            }
        }
        ...
        if($this->input->get('access_token')) {
            ...
            if(count($token_data) == 3) {
                ...
                if($token_status == 1) {
                    ...
                    $this->template_lib->load_view($this, '__vendor_account/Change_password_form_view', $this->_pdata);
	...
	public function change_password_success() {
        ...
        $this->template_lib->load_view($this, '__vendor_account/Change_password_success_view', $this->_pdata);
    }
}