...
/*
 * APPLICATION 		: club_and_bar Bookings Model
...
Class Club_and_bar_bookings_mdl extends CI_Model {
    ...
    public function get_club_and_bar_bookings($conditions = array(), $start, $limit) {
        ...
        ->from('tv_bookings_tbl as t1')
            ->join("tv_club_and_bar_booking_tbl as t2", 't2.booking_id=t1.booking_id','left');
    ...
    public function update_club_and_bar_booking($post_data, $club_and_bar_booking_id) {
        ...
        $this->db->update("tv_club_and_bar_booking_tbl", $data);
    }
