...
/*
 * APPLICATION 		: Transportation Invoice Request Model
...
class Transportation_invoice_request_mdl extends CI_Model {
    ...
    public function get_transportation_bookings($conditions = array(), $start, $limit) {
		...
		if (isset($conditions['search_transportation_invoice_date']) && !empty($conditions['search_transportation_invoice_date'])) {
			$this->db->where('t2.date_generated', lu_to_d($conditions['search_transportation_invoice_date']));
		}
		...
		if (isset($conditions['sort_transportation_invoice_date']) && !empty($conditions['sort_transportation_invoice_date'])){
			$this->db->order_by('t2.date_generated', $conditions['sort_transportation_invoice_date']);
		}
    ...
    public function get_transportation_booking($booking_id) {
        ...
        ->from("tv_transportation_booking_tbl as t1")
    ...
    public function update_transportation_booking($post_data, $transportation_booking_id) {
    ...
    public function get_invoice_data_by_booking_ids($booking_ids) {
        $this->db->select("t2.*, t1.agent_id, t1.agent_cost, t1.country_id, t1.city_id, t3.invoice_no, t3.date_generated, t4.booking_date, t4.booking_no")
            ->from("tv_transportation_tbl as t1")
                ->join("tv_transportation_booking_tbl as t2", "t1.id = t2.transportation_id" ,"left")
