...
<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open_multipart('admin/catalog/club_and_bar/edit?secure_token=' . $this->security_lib->encrypt($club_and_bar['id']), $attributes);
        ?>
        ...
        <h2>
            ...
            <span class="pull-right btn-toolbar">
                ...
                <?php
                    ...
                    echo form_button($attributes);
                ?>
                <a class="btn btn-red btn-icon icon-left" href="<?php echo base_url('admin/catalog/club_and_bar'); ?>">
                ...
                <div class="form-group <?php if(form_error('slug')) { echo 'validate-has-error'; } ?>">
                        ...
                        <div class="col-sm-8">
                            <?php
                                $attributes = array(
                                    'name' => 'slug',
                                    'placeholder' => 'Please Enter Slug(Seo URL) e.g. club-and-bar-name',
                                    'class' => 'form-control',
                                    'data-validate' => 'required, minlength[3], maxlength[255]',
                                    'data-message-required' => ' Slug( SEO URL ) is Required.',
                                    'value' => set_value('slug', $club_and_bar['slug'])
                                );
                    ...
                    <div class="form-group <?php if(form_error('type')) { echo 'validate-has-error'; } ?>">
                    	<?php
                            $attributes = array(
                                'class' => 'col-sm-3 control-label'
                            );
                    	...
                    	<div class="col-sm-8">
                    		<div class="radio">
                    			<label>
                    				<input type="radio" name="type" id="type-1" value="club" <?php echo $club_and_bar['type'] == 'club' ? 'checked':'' ?> >
                    					Club
                    			</label>
                    			<label>
                    				<input type="radio" name="type" id="type-2" value="bar" <?php echo $club_and_bar['type'] == 'bar' ? 'checked':'' ?>>
                    					Bar
                    			</label>
                    			<?php if(form_error('type')) { ?>
            						<?php echo form_error('type', '<span class="validate-has-error"><i class="entypo-cancel-circled"></i> ', '</span>'); ?>
            					<?php } ?>
                    		</div>
                    	</div>
                    </div>
                <div class="form-group <?php if(form_error('country_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $countries, set_value('country_id', $club_and_bar['country_id']));
						?>
               ...
               <div class="form-group <?php if(form_error('city_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $cities, set_value('city_id', $club_and_bar['city_id']));
						?>
                 ...
                 <div class="form-group <?php if(form_error('agent_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $agents, $club_and_bar['agent_id']);
						 ?>
                    	...
                    	<div class="input-group">
                            ...
                            <?php
                                $attributes = array(
                                    ...
                                    'value' => set_value('agent_cost', $club_and_bar['agent_cost'])
                                );
                ...
                <div class="form-group <?php if(form_error('price')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="input-group">
                            ...
                            <?php
                                $attributes = array(
                                    ...
                                    'value' => set_value('price', $club_and_bar['price'])
                                );
     			...
     			<div class="form-group <?php if(form_error('club_and_bar_category_id')) { echo 'validate-has-error'; } ?>">
                    <?php
                        $attributes = array(
                            'class' => 'col-sm-3 control-label'
                        );
    
                        echo form_label('Category : ', 'club_and_bar_category_id', $attributes);
                    ?>
                 	<div class="col-sm-8">
                        <?php
                            $attributes = array(
                                'name' => 'club_and_bar_category_id',
                                'id' => 'tour_category_id',
                            ...
                            echo form_dropdown($attributes, $categories, set_value('club_and_bar_category_id', $club_and_bar['club_and_bar_category_id']));
                        ?>
                         <?php if(form_error('club_and_bar_category_id')) { ?>
                    				<?php echo form_error('club_and_bar_category_id', '<span class="validate-has-error"><i class="entypo-cancel-circled"></i> ', '</span>'); ?>
                    			<?php } ?>
               	  </div>
             </div>
                ...
                <div class="form-group">
                    <?php
                        ...
                        echo form_label('Block Dates: ', 'club_and_bar_avalability', $attributes);
                    ?>
                    
                    <div class="col-sm-8">
						<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
						<script src="https://cdn.rawgit.com/dubrox/Multiple-Dates-Picker-for-jQuery-UI/master/jquery-ui.multidatespicker.js"></script>
						<input class="form-control" name="block_club_and_bar_dates" id="mdp-demo" value="<?php echo $blocked_dates; ?>" />
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="file-box news-feed-upload-image" id="image-section" data-username="<?php echo strtolower(str_replace(' ', '-', $this->session->userdata('username'))); ?>">
                            <ul class="rm list-inline rp">
                                <?php if (!empty($club_and_bar['images'])) { ?>
                                    <?php foreach ($club_and_bar['images'] as $row) { ?>
                            ...
                            <div class="make-switch" data-on="primary" data-off="info">
                                <?php
                                    $data = array(
                                        ...
                                        'id' => 'status',
                                        'value' => '1',
                                        'checked' => $club_and_bar['status'] == 1 ? TRUE : FALSE
                                    );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'value' => set_value('details[' . $language['code'] . '][title]', $club_and_bar_details[$language['code']]['title']),
                                            'data-validate' => 'required, minlength[3], maxlength[255]',
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'value' => set_value('details[' . $language['code'] . '][dsc]', $club_and_bar_details[$language['code']]['dsc']),
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'value' => set_value('details[' . $language['code'] . '][tags]', $club_and_bar_details[$language['code']]['tags'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_title]', $club_and_bar_details[$language['code']]['meta_title'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_dsc]', $club_and_bar_details[$language['code']]['meta_dsc'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_keywords]', $club_and_bar_details[$language['code']]['meta_keywords'])
                                        );
    ...
    $.each($('input[name="images[]"]'), function (i, obj) {
        $.each(obj.files, function (j, file) {
            ...
            $.ajax({
                ...
                // END
                url: base_url + 'admin/catalog/club_and_bar/add_image',
                contentType: false,
                processData: false,
                data: form_data,
                type: 'post',
...
function delete_edit_image(e) {
	...
	$.post(base_url + 'admin/catalog/club_and_bar/delete_image', form_data, function(response) {
...
<script>
    $('#country').on('change', function () {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('admin/catalog/club_and_bar/get_cities_by_country_id'); ?>",
