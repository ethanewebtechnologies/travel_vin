...
<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open_multipart('admin/catalog/wedding/edit?secure_token=' . $this->security_lib->encrypt($wedding['id']), $attributes);
        ?>
        ...
        <h2>
            ...
            <span class="pull-right btn-toolbar">
                ...
                <?php
                    ...
                    echo form_button($attributes);
                ?>
                <a class="btn btn-red btn-icon icon-left" href="<?php echo base_url('admin/catalog/wedding'); ?>">
		...
		<div class="panel panel-primary">
            <div class="panel-body">
                ...
                <div class="form-group <?php if(form_error('country_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $countries, set_value('country_id', $wedding['country_id']));
                    	?>
        		...
        		<div class="form-group <?php if(form_error('city_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $cities, set_value('city_id', $wedding['city_id']));
						?>
				...
				<div class="form-group <?php if(form_error('agent_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $agents, $wedding['agent_id']);
                        ?>
			  ...
			  <div class="form-group <?php if(form_error('wedding_category_id')) { echo 'validate-has-error'; } ?>">
                <?php
                    $attributes = array(
                        'class' => 'col-sm-3 control-label'
                    );

                    echo form_label('Category : ', 'wedding_category_id', $attributes);
                ?>
                 <div class="col-sm-8">
                    <?php
                        $attributes = array(
                            'name' => 'wedding_category_id',
                            'id' => 'wedding_category_id',
                        ...
                        echo form_dropdown($attributes, $categories, set_value('wedding_category_id', $wedding['wedding_category_id']));
                    ?>
                     <?php if(form_error('tour_category_id')) { ?>
                				<?php echo form_error('wedding_category_id', '<span class="validate-has-error"><i class="entypo-cancel-circled"></i> ', '</span>'); ?>
                			<?php } ?>
                 </div>
             </div>
                ...
                <div class="form-group">
                    <?php
                        ...
                        echo form_label('Block Dates: ', 'wedding_avalability', $attributes);
                    ?>
                    ...
                    <div class="col-sm-8">
						...
						<input class="form-control" name="block_wedding_dates" id="mdp-demo" value="<?php echo $blocked_dates; ?>" />
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="file-box news-feed-upload-image" id="image-section" data-username="<?php echo strtolower(str_replace(' ', '-', $this->session->userdata('username'))); ?>">
                            <ul class="rm list-inline rp">
                                <?php if (!empty($wedding['images'])) { ?>
                                    <?php foreach ($wedding['images'] as $row) { ?>
                            ...
                            <div class="make-switch" data-on="primary" data-off="info">
                                <?php
                                    $data = array(
                                        ...
                                        'id' => 'status',
                                        'value' => '1',
                                        'checked' => $wedding['status'] == 1 ? TRUE : FALSE
                                    );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'value' => set_value('details[' . $language['code'] . '][title]', $wedding_details[$language['code']]['title']),
                                            'data-validate' => 'required, minlength[3], maxlength[255]',
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'value' => set_value('details[' . $language['code'] . '][dsc]', $wedding_details[$language['code']]['dsc']),
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'value' => set_value('details[' . $language['code'] . '][tags]', $wedding_details[$language['code']]['tags'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_title]', $wedding_details[$language['code']]['meta_title'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_dsc]', $wedding_details[$language['code']]['meta_dsc'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'value' => set_value('details[' . $language['code'] . '][meta_keywords]', $wedding_details[$language['code']]['meta_keywords'])
                                        );
    ...
    $.each($('input[name="images[]"]'), function (i, obj) {
        $.each(obj.files, function (j, file) {
            ...
            $.ajax({
                ...
                // END
                url: base_url + 'admin/catalog/wedding/add_image',
                contentType: false,
                processData: false,
                data: form_data,
                type: 'post',
...
function delete_edit_image(e) {
	...
	$.post(base_url + 'admin/catalog/wedding/delete_image', form_data, function(response) {
...
<script>
    $('#country').on('change', function () {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('admin/catalog/wedding/get_cities_by_country_id'); ?>",
