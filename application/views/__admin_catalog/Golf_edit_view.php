...
<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open_multipart('admin/catalog/golf/edit?secure_token=' . $this->security_lib->encrypt($golf['id']), $attributes);
        ?>
        ...
        <h2>
            ...
            <span class="pull-right btn-toolbar">
                ...
                <?php
                    ...
                    echo form_button($attributes);
                ?>
                <a class="btn btn-red btn-icon icon-left" href="<?php echo base_url('admin/catalog/golf'); ?>">
                ...
                <div class="form-group <?php if(form_error('country_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $countries, set_value('country_id', $golf['country_id']));
						?>
               ...
               <div class="form-group <?php if(form_error('city_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $cities, set_value('city_id', $golf['city_id']));
							?>
                 ...
                 <div class="form-group <?php if(form_error('agent_id')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                        <?php
                            ...
                            echo form_dropdown($attributes, $agents, $golf['agent_id']);
							 ?>
                    	...
                    	<div class="input-group">
                            ...
                            <?php
                                $attributes = array(
                                    ...
                                    'class' => 'form-control',
                                    'value' => set_value('agent_cost', $golf['agent_cost']),
                                    'data-validate' => 'required',
                ...
                <div class="form-group <?php if(form_error('price')) { echo 'validate-has-error'; } ?>">
						...
						<div class="input-group">
                            ...
                            <?php
                                $attributes = array(
                                    ...
                                    'value' => set_value('price', $golf['price'])
                                );
                 ...
                 <div class="form-group <?php if(form_error('golf_category_id')) { echo 'validate-has-error'; } ?>">
                    <?php
                        $attributes = array(
                            'class' => 'col-sm-3 control-label'
                        );
    
                        echo form_label('Category : ', 'golf_category_id', $attributes);
                    ?>
                    <div class="col-sm-8">
                        <?php
                            $attributes = array(
                                'name' => 'golf_category_id',
                                'id' => 'golf_category_id',
                            ...
                            echo form_dropdown($attributes, $categories, set_value('golf_category_id', $golf['golf_category_id']));
                        ?>
                         <?php if(form_error('golf_category_id')) { ?>
                    				<?php echo form_error('golf_category_id', '<span class="validate-has-error"><i class="entypo-cancel-circled"></i> ', '</span>'); ?>
                    			<?php } ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <?php
                        ...
                        echo form_label('Block Dates: ', 'golf_avalability', $attributes);
                    ?>
                    
                    <div class="col-sm-8">
						<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
						<script src="https://cdn.rawgit.com/dubrox/Multiple-Dates-Picker-for-jQuery-UI/master/jquery-ui.multidatespicker.js"></script>
						<input class="form-control" name="block_golf_dates" id="mdp-demo" value="<?php echo $blocked_dates; ?>" />
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="file-box news-feed-upload-image" id="image-section" data-username="<?php echo strtolower(str_replace(' ', '-', $this->session->userdata('username'))); ?>">
                            <ul class="rm list-inline rp">
                                <?php if (!empty($golf['images'])) { ?>
                                    <?php foreach ($golf['images'] as $row) { ?>
                            ...
                            <div class="make-switch" data-on="primary" data-off="info">
                                <?php
                                    $data = array(
                                        ...
                                        'id' => 'status',
                                        'value' => '1',
                                        'checked' => $golf['status'] == 1 ? TRUE : FALSE
                                    );
                             ...
                             <div class="form-group <?php if(form_error('details[' . $language['code'] . '][title]')) { echo 'validate-has-error'; } ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    $attributes = array(
                                        ...
                                        'class' => 'form-control',
                                        'value' => set_value('details[' . $language['code'] . '][title]', $golf_details[$language['code']]['title']),
                                        'data-validate' => 'required, minlength[3], maxlength[255]',
                              ...
                              <div class="form-group <?php if(form_error('details[' . $language['code'] . '][dsc]')) { echo 'validate-has-error'; } ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    $attributes = array(
                                        ...
                                        'class' => 'form-control',
                                        'value' => set_value('details[' . $language['code'] . '][dsc]', $golf_details[$language['code']]['dsc']),
                            ...
                            <div class="form-group <?php if(form_error('details[en][tags]')) { echo 'validate-has-error'; } ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    $attributes = array(
                                        ...
                                        'value' => set_value('details[' . $language['code'] . '][tags]', $golf_details[$language['code']]['tags'])
                                    );
                             ...
                             <div class="form-group <?php if(form_error('details[en][meta_title]')) { echo 'validate-has-error'; } ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    $attributes = array(
                                        ...
                                        'class' => 'form-control',
                                        'data-validate' => "maxlength[255]",
                                        'value' => set_value('details[' . $language['code'] . '][meta_title]', $golf_details[$language['code']]['meta_title'])
                                    );
                            ...
                            <div class="form-group <?php if(form_error('details[en][meta_dsc]')) { echo 'validate-has-error'; } ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    $attributes = array(
                                        ...
                                        'class' => 'form-control',
                                        'data-validate' => "maxlength[255]",
                                        'value' => set_value('details[' . $language['code'] . '][meta_dsc]', $golf_details[$language['code']]['meta_dsc'])
                                    );
                            ...
                            <div class="form-group <?php if(form_error('details[en][meta_keywords]')) { echo 'validate-has-error'; } ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    $attributes = array(
                                        ...
                                        'value' => set_value('details[' . $language['code'] . '][meta_keywords]', $golf_details[$language['code']]['meta_keywords'])
                                    );
    ...
    $.each($('input[name="images[]"]'), function (i, obj) {
        $.each(obj.files, function (j, file) {
            ...
            $.ajax({
                ...
                // END
                url: base_url + 'admin/catalog/golf/add_image',
                contentType: false,
                processData: false,
                data: form_data,
                type: 'post',
...
function delete_edit_image(e) {
	...
	$.post(base_url + 'admin/catalog/golf/delete_image', form_data, function(response) {
...
<script>
    $('#country').on('change', function () {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('admin/catalog/golf/get_cities_by_country_id'); ?>",
