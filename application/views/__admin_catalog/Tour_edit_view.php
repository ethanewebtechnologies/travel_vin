...
<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open_multipart('admin/catalog/tour/edit?secure_token=' . $this->security_lib->encrypt($tour['id']), $attributes);
        ?>
        	...
        	<div class="panel panel-primary">
                                ...
                                <div class="make-switch has-switch" data-on-label="Yes" data-off-label="No">
                                    <?php
                                        $data = array(
                                            ...
                                            'id' => 'is_elite',
                                            'value' => '1',
                                            'checked' => $tour['is_elite'] == 1 ? TRUE : FALSE
                                        );
                        ...
                        <div class="col-sm-8">
                            <?php
                                $attributes = array(
                                    ...
                                    'class' => 'form-control',
                                    'value' => set_value('slug', $tour['slug']),
					...
					<div class="form-group <?php if(form_error('country_id')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="col-sm-8">
                            <?php
                                ...
                                echo form_dropdown($attributes, $countries, set_value('country_id', $tour['country_id']));
                            ?>
                	...
                	<div class="form-group <?php if(form_error('city_id')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="col-sm-8">
                        	<?php
                                ...
                                echo form_dropdown($attributes, $cities, set_value('city_id', $tour['city_id']));
                            ?>
                	...
                	<div class="form-group <?php if(form_error('agent_id')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="col-sm-8">
                        	<?php
                                ...
                                echo form_dropdown($attributes, $agents, set_value('agent_id', $tour['agent_id']));
                            ?>
                        	...
                        	<div class="input-group">
                            	...
                            	<?php
                                    $attributes = array(
                                        ...
                                        'value' => set_value('agent_cost', round($tour['agent_cost'], PRICE_DELIMITER))
                                    );
					...
					<div class="form-group <?php if(form_error('adult_price')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="col-sm-8">
                    		<div class="input-group">
    							<span class="input-group-addon">$</span>
                                <?php
                                    $adult_price = number_format($tour['adult_price'], PRICE_DELIMITER);
                                    ...
                                    $attributes = array(
                                        ...
                                        'value' => set_value('adult_price', round($tour['adult_price'], PRICE_DELIMITER))
                                    );
                	...
                	<div class="form-group <?php if(form_error('adult_deal_price')) { echo 'validate-has-error'; } ?>">
                        ...
                        <div class="col-sm-8">
                        	<div class="input-group">
    							<span class="input-group-addon">$</span>
                                <?php
                                    $adult_deal_price = number_format($tour['adult_deal_price'], PRICE_DELIMITER);
                                    ...
                                    $attributes = array(
                                        ...
                                        'value' => set_value('adult_deal_price', round($tour['adult_deal_price'], PRICE_DELIMITER))
                                    );
                	...
                	<div class="form-group <?php if(form_error('child_price')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="col-sm-8">
                    		<div class="input-group">
    							<span class="input-group-addon">$</span>
                                <?php
                                    $child_price = number_format($tour['child_price'], PRICE_DELIMITER);
                                    ...
                                    $attributes = array(
                                        ...
                                        'class' => 'form-control',
                                        'data-validate' => 'maxlength[19]',
                                        'value' => set_value('child_price', round($tour['child_price'], PRICE_DELIMITER))
                                    );
				...
				<div class="form-group <?php if(form_error('child_deal_price')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
                    	<div class="input-group">
    						<span class="input-group-addon">$</span>
                            <?php
                                $child_deal_price = number_format($tour['child_deal_price'], PRICE_DELIMITER);
                                ...
                                $attributes = array(
                                    ...
                                    'class' => 'form-control',
                                    'data-validate' => 'maxlength[19]',
                                    'value' => set_value('child_deal_price', round($tour['child_deal_price'], PRICE_DELIMITER)),
                                );
                    ...
                    <div class="col-sm-8">
                        <?php
                            $attributes = array(
                                ...
                                'data-validate' => 'range: [0, 12]',
                                'class' => 'form-control',
                                'value' =>  set_value('min_child_age', $tour['min_child_age'])
                            );
                    ...
                    <div class="col-sm-8">
                        <?php
                            $attributes = array(
                                ...
                                'name' => 'max_child_age',
                                'id' => 'max_child_age',
    							'placeholder' => 'Enter Child Maximum Age',
                                'class' => 'form-control',
                                'data-validate' => 'range: [16]',
                                'value' =>  set_value('max_child_age', $tour['max_child_age'])
                            );
                            echo form_input($attributes);
                        ?>
                    ...
                    ?>
                 	<div class="col-sm-8">
                    	<?php
                            ...
                            echo form_dropdown($attributes, $categories, set_value('tour_category_id', $tour['tour_category_id']));
                        ?>
                ...
                <div class="form-group <?php if(form_error('tour_avalability')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="col-sm-8">
						...
						<input class="form-control" name="block_tour_dates" id="mdp-demo" value="<?php echo $blocked_dates; ?>" />
                        ...
                        <div class="file-box news-feed-upload-image" id="image-section" data-username="<?php echo strtolower(str_replace(' ', '-', $this->session->userdata('username'))); ?>">
							<ul class="rm list-inline rp">
                                <?php if (!empty($tour['images'])) { ?>
                                    <?php foreach ($tour['images'] as $row) { ?>
                                ...
                                <li id ="add-image-box">
                                    ...
                                    <input type="file" multiple class="form-control" id="post_edit_images" name="input_images" accept="image/x-png,image/gif,image/jpeg">
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <?php
                            $data = array(
                                ...
                                'class' => 'form-control',
                                'value' => set_value('sort_order', $tour['sort_order'])
                            );
                            ...
                            <div class="make-switch" data-on="primary" data-off="info">
                                <?php
                                    $data = array(
                                        ...
                                        'id' => 'status',
                                        'value' => '1',
                                        'checked' => $tour['status'] == 1 ? TRUE : FALSE
                                    );
                                	...
                                	<?php if($language['code'] == 'en') { ?>
                                        <?php
                                            $attributes = array(
                                                ...
                                                'value' => set_value('details[' . $language['code'] . '][title]', $tour_details[$language['code']]['title'])
                                            );
                                	...
                                	<?php if($language['code'] == 'en') { ?>
                                        <?php
                                            $attributes = array(
                                                ...
                                                'data-message-required' => 'Description required .',
                                                'value' => set_value('details[' . $language['code'] . '][dsc]', $tour_details[$language['code']]['dsc'])
                                            );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'value' => set_value('details[' . $language['code'] . '][tags]', $tour_details[$language['code']]['tags'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_title]', $tour_details[$language['code']]['meta_title'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'class' => 'form-control',
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_dsc]', $tour_details[$language['code']]['meta_dsc'])
                                        );
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        $attributes = array(
                                            ...
                                            'data-validate' => "maxlength[255]",
                                            'value' => set_value('details[' . $language['code'] . '][meta_keywords]', $tour_details[$language['code']]['meta_keywords'])
                                        );
...
$('#post_edit_images').change(function (e) {
    ...
    $.each($('input[name="input_images"]'), function (i, obj) {
