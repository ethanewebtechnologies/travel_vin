...
<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open('admin/catalog/wedding/add', $attributes);
        ?>
		  <!-- CSRF NAME -->
        <?php
			$attributes = array(
            ...
            <div class="panel-body">
                ...
                <div class="form-group <?php if(form_error('wedding_category_id')) { echo 'validate-has-error'; } ?>">
                        ...
                        <div class="col-sm-8">
                            ...
                            ?>
                            <?php if(form_error('wedding_category_id')) { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
						...
						<input class="form-control" name="block_wedding_dates" id="mdp-demo" />
