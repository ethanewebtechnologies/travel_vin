...
<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open('admin/catalog/club_and_bar/add', $attributes);
        ?>
		  <!-- CSRF NAME -->
        <?php
			$attributes = array(
        ...
        <!-- END OF CSRF  -->
        <h2>
            <?php echo "Add Club And Bar Details"; ?>
            ...
            <div class="panel-body">
				<div class="form-group <?php if(form_error('slug')) { echo 'validate-has-error'; } ?>">
                    ...
                    <div class="form-group <?php if(form_error('type')) { echo 'validate-has-error'; } ?>">
                    	...
                    	<div class="col-sm-8">
                    		<div class="radio">
                    			<label>
                    				<input type="radio" name="type" id="type-1" value="club" checked>
                    					Club
                    			</label>
                    			<label>
                    				<input type="radio" name="type" id="type-2" value="bar">
                    					Bar
                    			</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
						...
						<input class="form-control" name="block_club_and_bar_dates" id="mdp-demo" />
                                ...
                                <?php if (isset($postimage) && !empty($postimage)) { ?>
                                    <?php foreach($postimage as $image) { ?>
                                        <li class="new-image uploaded">
                                            ...
                                            <input type="hidden" name="postimage[]" value="<?php echo $image; ?>">
                                        </li>
                                    <?php } ?>
                                <?php } ?>
