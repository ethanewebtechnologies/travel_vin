<div class="row">
	...
	<?php 
		  ...
		  echo form_open('admin/settings/restricted-zone/edit?secure_token=' . $this->security_lib->encrypt($restricted_zone['id']), $attributes); 
		?>
			<h2>
        		<?php echo "Edit Tour Details"; ?> 
