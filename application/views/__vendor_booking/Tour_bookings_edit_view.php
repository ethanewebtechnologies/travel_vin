<div class="row">
    <div class="col-md-12">
        <?php
            ...
            echo form_open_multipart('vendor/booking/tour-bookings/edit?secure_token=' . $this->security_lib->encrypt($tour_booking['booking_id']), $attributes);
        ?>
            <!-- CSRF NAME -->
            <?php
                $attributes = array(
                                ...
                                <div class="make-switch" data-on="primary" data-off="info">
                                    <?php
                                        $data = array(
                                            ...
                                            'id' => 'status',
                                            'value' => '1',
                                            'checked' => $tour_booking['status'] == '1' ? TRUE : FALSE
                                        );
...
<link rel="stylesheet" href="http://localhost/travel_vin/assets/admin/css/neon-forms.css">
<script>
$(function(){
