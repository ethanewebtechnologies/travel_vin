				...
				<div class="col-sm-7">
					<div class="tour_desc_wrap">
						...
						<div class="tour_name">
							...
							<div>
							<?php if($restaurant['price'] != 0 ) { ?>
							$<?php echo number_format($restaurant['price']); ?> USD
							<?php } ?>	
							</div>
						</div>
				...
				<div class="col-sm-5">
					<div class="tour_form_wrap">
						<div class="tourform_blk">
							<?php echo form_open(); ?>
								<input type="hidden" name="_pid" value="<?php echo $restaurant['restaurant_id']; ?>" />
                                ...
                                <div class="form-group">
                                    <?php 
                                        echo form_label($text_restaurant_start_date,'start_date');
