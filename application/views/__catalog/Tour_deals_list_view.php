<main>
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<div class="countries">
											...
											<a class="dropdown-item" href="<?php echo base_url('deals/' . $value['seo_url'] . '/' . $data['seo_url']); ?>"><?php echo $data['name'];?></a>
											<?php }}?>
										</div>
									</div>
									<?php }?>
	...
	<?php if(isset($deal_banners['main']) && !empty($deal_banners['main'])){?>
				...
				<div class="banner">
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<?php 
							foreach ($deal_banners['main'] as $key => $deal_banners) { ?>
							<?php if(isset($deal_banners['image']) && file_exists($deal_banners['image'])) { ?>
								<div class="item <?php echo $key == 0 ? 'active' : ''; ?>">
        								<?php echo $optimized->resize($deal_banners['image'], 1349, 521, array('class' => 'd-block w-100 img-fluid', 'alt' =>$deal_banners['title']), 'resize_crop'); ?>
								</div>
    								<?php } ?>
							<?php } ?>
						</div>
					...
					<div class="bnr_text">
						<div class="bnr_wrap_text">
							<h1 class="wow zoomIn" data-wow-delay="1s"><?php echo $deal_configuration['main_title']; ?></h1>
							<h5><?php echo $deal_configuration['sub_title']; ?></h5>
							<div>
								<p class="spcl_txt"><?php echo $deal_configuration['boxed_title']; ?></p>
							</div>
						</div>
					</div>
				</div>
	...
	<?php } ?>
	<?php if(isset($deal_configuration['banner_dsc']) && !empty($deal_configuration['banner_dsc'])){?>
	<section class="transport_blk">
		<section class="container">
			<section class="row">
				<div class="col-sm-12">						
					<div class="form_text_blk no-shadow">
						<h3><?php echo $deal_configuration['banner_dsc']; ?></h3>
					</div>
				</div>
			</section>
		</section>
							...
							<?php foreach ($tours as $tour) { ?>
								<div class="single_list_blk">
    								...
    								<div class="price_detail">
        								...
        								<?php } ?>
    									<a href="<?php echo base_url('deals/' . $tour['country_seo_url'] . '/' . $tour['city_seo_url'] . '/' . $tour['slug']); ?>"><?php echo $text_Book_Now;?></a>
    								</div>
    							</div>
							<?php } ?>
