<main>
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<div class="countries">
											...
											<a class="dropdown-item" href="<?php echo base_url('elite-tours/' . $value['seo_url'] . '/' . $data['seo_url']); ?>"><?php echo $data['name'];?></a>
											<?php }}?>
										</div>
									</div>
									<?php }?>
	...
	<?php if(isset($elite_banners['main']) && !empty($elite_banners['main'])){?>
				...
				<div class="banner">
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<?php 
							foreach ($elite_banners['main'] as $key => $elite_banner) { ?>
							<?php if(isset($elite_banner['image']) && file_exists($elite_banner['image'])) { ?>
								<div class="item <?php echo $key == 0 ? 'active' : ''; ?>">
        								<?php echo $optimized->resize($elite_banner['image'], 1349, 521, array('class' => 'd-block w-100 img-fluid', 'alt' => $elite_banner['title']), 'resize_crop'); ?>
								</div>
    								<?php } ?>
							<?php } ?>
						</div>
					...
					<div class="bnr_text">
						<div class="bnr_wrap_text">
							<h1 class="wow zoomIn" data-wow-delay="1s"><?php echo $elite_configuration['main_title']; ?></h1>
							<h5><?php echo $elite_configuration['sub_title']; ?></h5>
							<div>
								<p class="spcl_txt"><?php echo $elite_configuration['boxed_title']; ?></p>
							</div>
						</div>
					</div>
				</div>
	...
	<?php } ?>
	<?php if(isset($elite_configuration['banner_dsc']) && !empty($elite_configuration['banner_dsc'])){?>
	<section class="transport_blk">
		<section class="container">
			<section class="row">
				<div class="col-sm-12">						
					<div class="form_text_blk no-shadow">
						<h3><?php echo $elite_configuration['banner_dsc']; ?></h3>
					</div>
				</div>
			</section>
		</section>
								...
								<div class="single_list_blk">
									<div class="tourimg">
										<?php if(isset($tour['image']) && file_exists($tour['image'])) { ?>
											<img src="<?php echo base_url($tour['image']); ?>" alt="">
										<?php } else { ?>
											<img src="<?php echo base_url('assets/img/empty.jpg'); ?>" alt="">
										<?php } ?>
									...
									<div class="price_detail">
										...
										<?php } ?>
										<a href="<?php echo base_url('elite-tours/' . $tour['country_seo_url'] . '/' . $tour['city_seo_url'] . '/' . $tour['slug']); ?>"><?php echo $text_Book_Now;?></a>
									</div>
								</div>
							<?php } ?>
