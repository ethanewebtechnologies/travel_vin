...
<html>
    <head>
        <meta charset="utf-8" />
        <title><?php echo $text_reset_password;?></title>
    ...
    <body>
        <div style="width: 800px;margin: 0 auto;font-family: arial;font-size: 14px;">
                ...
                <tbody>
                    <tr>
                        <td style="padding: 0 10px;border-left: 1px solid #ddd;border-right: 1px solid #ddd;">
                            <p style="margin:15px 0; padding: 0 0 60px 0;margin: 10px 0;"><span style="display: inline-block;float: left;margin-top: 20px;    font-size: 18px;"><?php echo $text_hey;?> <?php echo $customer_name; ?>,</span> </p>

                            <p style="margin:15px 0; font-family: 14px;color:green;"><?php echo $text_reset_your_password; ?> <a href="<?php echo $change_password_link; ?>"><?php echo $text_click_here?></a> </p>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 10px;border-left: 1px solid #ddd;border-right: 1px solid #ddd;">
                            ...
                            <p style="margin:15px 0; font-size: 16px;margin-top: 6px;"><?php echo $text_email_admin;?></p>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table style="width: 100%;border-top: 0;font-family: arial;font-size: 14px;background: #212121;" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td style="color: #ddd;"><p style="margin:15px 0; text-align: center;font-size: 12px;">© 2017 <?php echo $text_email_poweredby; ?> <a style="color: #d38235;text-decoration: none;" href="http://www.ethanetechnologies.com/" target="_blank"><?php echo $text_ethane_web_technologies;?></a></p></td>
                    </tr>
                </tbody>
            </table>
        </div>
