...
<html>
    <head>
        <meta charset="utf-8" />
        <title><?php echo $text_page_tittle_vendor;?></title>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 0 10px;border-left: 1px solid #ddd;border-right: 1px solid #ddd;">
                            <p style="margin:15px 0; padding: 0 0 60px 0;margin: 10px 0;"><span style="display: inline-block;float: left;margin-top: 20px;    font-size: 18px;"><?php echo $text_customer_greeting; ?> <?php echo $vendor_name; ?>,</span> </p>

                            <p style="margin:15px 0; font-family: 14px;color:green;"><?php echo $message; ?><a href="<?php echo $reset_link; ?>"><?php echo $click_text; ?></a> </p>
